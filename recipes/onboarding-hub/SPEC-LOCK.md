...
- Call `glean.chat.create` from the server with `GLEAN_SERVER_URL` and `GLEAN_API_TOKEN`.
...
Both paths verify cited answers for supported first-day, VPN, and PTO questions. The Platform Chat path
