...
| 3   | Initial account summary      | First assistant message comes from an account-framed Platform Chat call        | First assistant message comes from `glean.agents.createRun` | "Give me a customer summary"                          |
...
| 7   | Empty / unfinished synthesis | Completed response with no answer text → error, not a blank success            | Empty GLEAN_AI text → error                                 | Transport failure, not missing evidence               |
