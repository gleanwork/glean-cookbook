...
- **[chat-api/](chat-api/)** - you own the UI. Chat API from a small local server.

The Chat API path records a first run you can play without credentials (`npm run verify:fixture`). The Web SDK path uses the Glean session already in your browser.
