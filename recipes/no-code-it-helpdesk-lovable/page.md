...
1. Get your secrets ready before you start.
...
2. Start a new Lovable project and paste this whole block — fill in your
   instance name first.
   ...
   identity, so every request has the token owner's Glean access. Keep the
   project private. A multi-user deployment requires app authentication and a
   per-user Glean OAuth token. Do not add a ticketing integration.
   ````
...
3. Test with the two demo queries below, then check your browser's Network
